...
const Navbar = () => {
    ...
    return (
        ...
        <div className='nav flex gap-5 text-accent'>  {/*lg:ml-[185px]*/}
                <NavLink className='font-bold hover:text-gray-700' to="/">Home</NavLink>
                <NavLink className='font-bold hover:text-gray-700' to="/about">About</NavLink>
                <NavLink className='font-bold hover:text-gray-700' to="/bookmark">Bookmark</NavLink>
            </div>
